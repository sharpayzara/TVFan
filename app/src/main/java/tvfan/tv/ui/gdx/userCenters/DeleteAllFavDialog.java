...
public class DeleteAllFavDialog extends Dialog {
	...
	public DeleteAllFavDialog(final Page page, Context context) {
		super(page);
		setSize(1520, 1080);
		setPosition(400, 0);
		...
		sure.setOnClickListener(new OnClickListener() {
			...
			public void onClick(Actor arg0) {
				favOR._deleteAll();
				DeleteAllFavDialog.this.dismiss();
			}
		});
		addActor(sure);
	...
	public void _initData(FavoritesItem favOR){
		this.favOR = favOR;
		titleLabel.setText("点击确认即可删除全部收藏");
	}
}
