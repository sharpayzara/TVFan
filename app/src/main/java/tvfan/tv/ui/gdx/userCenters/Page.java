		...
		/*case 0:
			...
			case 0:
				if (playHistory == null) {
					...
					playHistory.setSize(1920-400, 1080);
		...
		switch (keycode) {
			...
			case KeyEvent.KEYCODE_DPAD_RIGHT:
				...
				switch (iprepos) {
					...
					case 1:
						if (!fmark) {
							if(favorites != null && favorites.programList.size() > 0){
								favorites.mGrid.setSelection(0,true);
							}else {
