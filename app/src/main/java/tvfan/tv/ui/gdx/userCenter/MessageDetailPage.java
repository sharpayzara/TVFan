...
import tvfan.tv.daemon.EPGUpdateService;
...
public class MessageDetailPage extends BasePage implements LoaderListener {
	...
	public void getView() {
		...
		if (msgAction != null) {
			if (msgAction.equals("OPENTXT")) {
				...
				sure = new Button(this, 350, 150);
				sure.setPosition(785, mesLabelypos - mesLabel1Hight - 100);
	...
	private void initTitle() {
		...
		timeLabel.setText(time);
		timeLabel.setPosition(1920 - 400 - 150, 1080 - 190);
		...
		if (img != null && !img.equals("")&&!img.equals("无")) {
			...
			mesImg.setSize(600, 400);
			mesImg.setPosition(660, 430);
