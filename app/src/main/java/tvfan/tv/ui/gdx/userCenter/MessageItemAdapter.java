...
public class MessageItemAdapter extends GridAdapter {
	...
	class MessageGridItem extends Group implements IListItem {
		...
		public MessageGridItem(Page page) {
			...
			image.setDrawableResource(R.drawable.info);
			addActor(image);
			...
			label.setTextColor(Color.parseColor("#FFEC8B"));
			label.setAlpha(0.9f);
			...
			focusImg.setSize(1280, 156);
			focusImg.setDrawableResource(R.drawable.new_foucs);
			focusImg.setPosition(-30, -28);
		...
		public void onResume() {
			Utils.resetImageSource(image, R.drawable.info);
