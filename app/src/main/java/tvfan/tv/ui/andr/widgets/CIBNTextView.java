 ...
 * 解决Textview提前换行问题
 */
public class CIBNTextView extends TextView
{
	/**
	 * 缓存测量过的数据
	 */
	...
	public CIBNTextView(Context context) {
		super(context);
		init(context);
	}

	public CIBNTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public CIBNTextView(Context context, AttributeSet attrs, int defStyle) {
